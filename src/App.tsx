...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#FFF8F6] font-sans">
      ...
      {/* Hero */}
      <div className="bg-[#8B4513] text-white py-10 px-4">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* 導入文 */}
        <section className="mb-8 bg-white rounded-2xl shadow p-6 border-l-4 border-[#8B4513]">
          <h2 className="text-base font-bold text-gray-800 mb-3 flex items-center gap-2">
            <span>📢</span> 今日の結論：どこが一番安いか
          </h2>
          <p className="text-sm text-gray-700 leading-relaxed">
            <strong className="text-[#8B4513]">今日Amazonで最もお得なのは製菓型・天板カテゴリ</strong>です。
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-base font-bold text-gray-800 flex items-center gap-2">
                <span className="bg-[#8B4513] text-white text-xs px-2 py-0.5 rounded-full">LIVE</span>
              ...
              <div className="lg:hidden flex items-center gap-2">
                ...
                >
                  ...
                  絞り込み
                  {hasActiveFilter && <span className="bg-[#8B4513] text-white text-xs rounded-full w-4 h-4 flex items-center justify-center">!</span>}
                </button>
              </div>
            ...
            {loading ? (
              ...
              <div className="flex flex-col items-center justify-center py-16 text-center">
                ...
                <button onClick={() => setFilter(DEFAULT_FILTER)} className="bg-[#8B4513] text-white px-6 py-2.5 rounded-full text-sm font-medium">
                  フィルターをリセット
                </button>
              </div>
            ) : (
