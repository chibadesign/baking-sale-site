        ...
        <div className="flex items-center justify-between h-14">
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <span className="text-base font-bold text-[#FF8C00]">セール</span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={onRefresh}
              disabled={loading}
              className="flex items-center gap-1.5 bg-[#FF8C00] hover:bg-[#e67e00] disabled:opacity-50 text-white px-3 py-1.5 rounded-full text-xs font-medium transition-colors"
            >
